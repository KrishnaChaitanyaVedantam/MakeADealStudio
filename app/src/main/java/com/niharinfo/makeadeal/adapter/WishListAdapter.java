...
import com.niharinfo.makeadeal.WishListActivity;
...
/**
 * Created by subbarao on 27/5/15.
 */
public class WishListAdapter extends ArrayAdapter<WhishListResponse> {

    private Context mContext;
    private List<WhishListResponse> productList;
    int res;

    public WishListAdapter(Context context, int res1, List<WhishListResponse> listResponses) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final WhishListResponse response = productList.get(position);
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                WishListRemove gitapi = restAdapter.create(WishListRemove.class);
                gitapi.whishlistadd(ServiceHandlers.USERID, response.getPid(), new Callback<WhistListAddReponse>() {
                    ...
                    public void success(WhistListAddReponse whistListAddReponse, Response response) {
                        if (whistListAddReponse.getResponse().equals("sucess")) {
                            ...
                            if(CategoriesActivity.wish_count==0){
                                WishListActivity.txtWishlistItems.setVisibility(View.VISIBLE);
                            }else{
                                WishListActivity.txtWishlistItems.setVisibility(View.INVISIBLE);
                            }
                        }
                    }
                    @Override
